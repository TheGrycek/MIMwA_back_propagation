function [wektor_wag_hid, wektor_wag_out, wektor_bias_hid, wektor_bias_out] = Backprop_alg_z2(E, wektor_wej, wektor_uczacy, wektor_wag_hid, wektor_wag_out, wektor_bias_hid, wektor_bias_out)
